 ...
 *  For details, see the Prototype web site: /web/20120125222315/http://prototype.conio.net/
 *
/*--------------------------------------------------------------------------*/
...
// Copyright (c) 2005, 2006 Thomas Fuchs (/web/20120125222315/http://script.aculo.us, /web/20120125222315/http://mir.aculo.us)
// Contributors:
//  Justin Palmer (/web/20120125222315/http://encytemedia.com/)
//  Mark Pilgrim (/web/20120125222315/http://diveintomark.org/)
//  Martin Bialasinki
// 
// script.aculo.us is freely distributable under the terms of an MIT-style license.
// For details, see the script.aculo.us web site: /web/20120125222315/http://script.aculo.us/ 
...
// Copyright (c) 2005, 2006 Thomas Fuchs (/web/20120125222315/http://script.aculo.us, /web/20120125222315/http://mir.aculo.us)
//           (c) 2005, 2006 Ivan Krstic (/web/20120125222315/http://blogs.law.harvard.edu/ivan)
//           (c) 2005, 2006 Jon Tirsen (/web/20120125222315/http://www.tirsen.com)
// Contributors:
//  Richard Livsey
//  Rahul Bhargava
//  Rob Wills
...
//
// see documentation on /web/20120125222315/http://wiki.script.aculo.us/scriptaculous/show/Ajax.InPlaceEditor
...
// Copyright (c) 2005, 2006 Thomas Fuchs (/web/20120125222315/http://script.aculo.us, /web/20120125222315/http://mir.aculo.us)
//           (c) 2005, 2006 Sammi Williams (/web/20120125222315/http://www.oriontransfer.co.nz, sammi@oriontransfer.co.nz)
// 
// script.aculo.us is freely distributable under the terms of an MIT-style license.
// For details, see the script.aculo.us web site: /web/20120125222315/http://script.aculo.us/
 ...
 * reflection.js v1.6
 *
 * Contributors: Cow /web/20120125222315/http://cow.neondragon.net
 *               Gfx /web/20120125222315/http://www.jroller.com/page/gfx/
 *               Sitharus /web/20120125222315/http://www.sitharus.com
 *               Andreas Linde /web/20120125222315/http://www.andreaslinde.de
 *               Tralala, coder @ /web/20120125222315/http://www.vbulletin.org
 *
...
Object.extend(Object.extend(Effect.Tooltip.prototype, Effect.Base.prototype), {
  ...
  hideTip: function(){
	...
	positionTip2: function() {
		var arrow = this.arrow;//$(gtip).down('span.gtip-arrow');
		...
		var xWidth   = 200;
		if (viewport.xWidth>(eltpos[0]+this.element.getWidth()+xWidth)){
			var left = eltpos[0] + this.element.getWidth() + 15;
